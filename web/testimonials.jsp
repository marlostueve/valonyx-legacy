...
<title>Valeo Wellness Center Testimonials on Chiropractic and Other Health Care</title>

<meta name="description" content="Read testimonials from Valeo Wellness Center patients, including patients that have used Valeo's chiropractic, massage, naturopathy, acupuncture, and natural health care services.">
...
for (int i = 1; i <= 17; i++)
{
	String label = content_page.getNewsPropertyString("testimonial_label_" + i);
	String value = content_page.getNewsPropertyString("testimonial_content_" + i);
