...
<%
NewsItemBean why_page = null;
try
{
	why_page = NewsItemBean.getNewsItemBean(3);
}
catch (ObjectNotFoundException x)
{
	why_page = new NewsItemBean();
	why_page.setName("why");
}
%>
...
<title>Valeo Wellness Center Eden Prairie</title>

<meta name="description" content="Valeo Wellness Center in Eden Prairie offers acupuncture health services to treat a variety of health issues. Our Eden Prairie, MN office is open Monday - Friday, starting at 7 a.m.">
...
for (int i = 1; i <= 9; i++)
{
	String label = why_page.getNewsPropertyString("label_" + i);
	String value = why_page.getNewsPropertyString("content_" + i);
