...
try
{
	content_page = NewsItemBean.getNewsItemBean(7);
}
...
<title>Valeo Wellness Center : Meet the Staff</title>

<meta name="description" content="The staff at Valeo Wellness Center assist the health care providers at the office provide high quality health care for all of our Twin Cities patients for their chiropractic, acupuncture and massage appointments.">
<meta name="keywords" content="Tanya Brown, Christine Carlson, Kerri Champion, Sue Monson, Jill Duzan, Gail Towey, Valeo Wellness Center, natural health care, wellness center, chiropractic, massage, naturopathy, acupuncture, natural health solutions, back pain, lower back pain, headaches, alternative medicine, alternative health care, Eden Prairie, MN, Twin Cities, Edina, Chanhassen">
...
for (int i = 1; i <= 9; i++)
{
	String label = content_page.getNewsPropertyString("staff_name_" + i);
	String value = content_page.getNewsPropertyString("staff_content_" + i);
