...
/*
if (CUBean.getProperty("cu.webDomain") != null && CUBean.getProperty("cu.webDomain").indexOf("valonyx") > -1) {
	StringBuffer bufx = new StringBuffer();
	Enumeration enumx = request.getHeaderNames();
	while (enumx.hasMoreElements()) {
		String header_name = (String)enumx.nextElement();
		String header = request.getHeader(header_name);
		if (header.indexOf("Baiduspider") > -1) {
			//CUBean.sendEmail("marlo@valonyx.com", "admin@valonyx.com", "Spider Kill", header);
			return;
		}
		bufx.append(header_name + " = " + header + "  <br />  ");
	}
	//CUBean.sendEmail("marlo@valonyx.com", "admin@valonyx.com", "Valonyx index visit", bufx.toString());
}
*/
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"> 
	<head> 
		...
		<meta name="keywords" content="practice management, scheduling software, POS, point of sale, QuickBooks integration, web based practitioner scheduling, point of sale scheduling, multi practitioner scheduling, wellness center management" /> 
