...
<%@ include file="channels\channel-date.jsp" %>
			<div id="serviceswhere">
				...
				<div id="news">
				    <h2>Vision</h2>
				    <ul>
				    <li><img src="images/vision.jpg" alt="Vision"><strong>Working as a unified team to see that every man, woman and child can experience God's unlimited love and freedom in every aspect of life.</strong></li>
				    </ul>
				</div><!-- div#news -->
				<div id="news">
				    <h2>Mission</h2>
				    <ul>
				    <li><img src="images/mission.jpg" alt="Mission"><strong>To inspire and empower people to desire an abundance of health and healing; accomplished through compassionate care.</strong></li>
				    </ul>
				</div><!-- div#news -->
				<div id="news">
				    <h2>Purpose</h2>
