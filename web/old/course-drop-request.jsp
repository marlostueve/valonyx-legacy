...
<%
if (request.getParameter("dropCourseId") != null)
{
    try
    {
        userCourse = CourseBean.getCourse(Integer.parseInt(request.getParameter("dropCourseId")));
...
<TABLE WIDTH=772 BORDER=0 CELLPADDING=0 CELLSPACING=0>
	...
	<TR>
	    <struts-html:form action="/courseDropRequest">
		...
		<TD WIDTH=582 ALIGN=left VALIGN=top>
			...
			<TABLE WIDTH=582 BORDER=0 CELLPADDING=1 CELLSPACING=0 BGCOLOR="#CCA34A">
				<TR HEIGHT=26>
					<TD ALIGN=left BACKGROUND="images/PttrsnUK_TableHeaderBG.jpg"><P style="font-size: 13pt; font-family: Arial; font-weight: bold; color: #000000;">&nbsp;Course Drop Request</P></TD>
				</TR>
				<TR>
					<TD WIDTH=580>
...
<%
System.out.println("userCourse.allowInstructorDropApproval() >" + userCourse.allowInstructorDropApproval());
if (userCourse.allowManagerDropApproval())
{
%>
										<TR>
...
if (userCourse.allowInstructorDropApproval())
{
%>
										<TR>
						...
						<TABLE WIDTH=138 BORDER=0 CELLPADDING=0 CELLSPACING=0>
							...
							<TR BGCOLOR="#FFFFFF">
								...
								<TD ALIGN=center VALIGN=top>
									...
									<BR>
                                                                        <input type="image" name="submit_request" src="images/PttrsnUK_BTN-DSave.jpg" ALT="Submit Drop Request" onclick="javascript:if (confirm('Are you sure?')) return true; else return false;">
									<BR><BR>
									</P>
