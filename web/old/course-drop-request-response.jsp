...
<TABLE WIDTH=772 BORDER=0 CELLPADDING=0 CELLSPACING=0>
	...
	<TR>
	    <struts-html:form action="/courseDropRequestResponse">
		...
		<TD WIDTH=582 ALIGN=left VALIGN=top>
			...
			<TABLE WIDTH=582 BORDER=0 CELLPADDING=1 CELLSPACING=0 BGCOLOR="#CCA34A">
				<TR HEIGHT=26>
					<TD ALIGN=left BACKGROUND="images/PttrsnUK_TableHeaderBG.jpg"><P style="font-size: 13pt; font-family: Arial; font-weight: bold; color: #000000;">&nbsp;Course Drop Request Response</P></TD>
				</TR>
				<TR>
					<TD WIDTH=580>
						...
						<TABLE WIDTH=138 BORDER=0 CELLPADDING=0 CELLSPACING=0>
							...
							<TR BGCOLOR="#FFFFFF">
								...
								<TD ALIGN=center VALIGN=top>
									...
									<BR>
                                                                        <input type="image" name="approve_request" src="images/PttrsnUK_BTN-DSave.jpg" ALT="Approve Drop Request" onclick="javascript:if (confirm('Approve Request.  Are you sure?')) return true; else return false;">
									<BR><BR>
									</P>
								</TD>
							</TR>
							...
							<TR BGCOLOR="#FFFFFF">
								...
								<TD ALIGN=center VALIGN=top>
									<P style="font-size: 9pt; font-family: Arial; color: #000000;">
									<BR>
                                                                        <input type="image" name="deny_request" src="images/PttrsnUK_BTN-DSave.jpg" ALT="Deny Drop Request" onclick="javascript:if (confirm('Deny Request.  Are you sure?')) return true; else return false;">
									<BR><BR>
									</P>
								</TD>
							</TR>
