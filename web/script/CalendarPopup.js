...
function CP_getCalendar() {
	...
	if (this.displayType=="date" || this.displayType=="week-end") {
		...
		for (var row=1; row<=6; row++) {
			...
			for (var col=1; col<=7; col++) {
				...
				if (disabled || this.disabledWeekDays[col-1]) {
					...
					result += '	<TD CLASS="'+this.cssPrefix+dateClass+'"><A HREF="javascript:'+windowref+this.returnFunction+'('+selected_year+','+selected_month+','+selected_date+');changeLinkText();'+windowref+'CP_hideCalendar(\''+this.index+'\');" CLASS="'+this.cssPrefix+dateClass+'">'+display_date+'</A></TD>\n';
					}
				display_date++;
		...
		if (disabled || this.disabledWeekDays[current_weekday+1]) {
			...
			//result += '		<A CLASS="'+this.cssPrefix+'cpTodayText" HREF="javascript:markEmpty();changeLinkText();removeEntry();'+windowref+'CP_hideCalendar(\''+this.index+'\');"></A>';
			//result += '		|';
			//result += '		<A CLASS="'+this.cssPrefix+'cpTodayText" HREF="javascript:markCompleted();changeLinkText();'+windowref+'CP_hideCalendar(\''+this.index+'\');"></A>\n';
			}
		result += '		<BR>\n';
