    ...
    <div id="center1" style="background-color: white;">
		...
		<div id="content">
			...
			<div class="content_TextBlock">
				<p class="headline"><%= adminCompany.getLabel() %> - Clients - <span id="selectedPerson"><%= adminPerson.isNew() ? "No Client Selected" : adminPerson.getLabel() %></span> - EHR - Problem List </p>
...
<%@ include file="channels/channel-client-menu.jsp" %>
				...
				<div class="main">
						...
						<p>Record or modify the <strong>problem list</strong> for <%= adminPerson.getLabel() %>.</p>
