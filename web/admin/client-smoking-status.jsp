    ...
    <div id="center1" style="background-color: white;">
		...
		<div id="content">
			...
			<div class="content_TextBlock">
				<p class="headline"><%= adminCompany.getLabel() %> - Clients - <span id="selectedPerson"><%= adminPerson.isNew() ? "No Client Selected" : adminPerson.getLabel() %></span> - EHR - Smoking Status </p>
...
<%@ include file="channels/channel-client-menu.jsp" %>
				...
				<div class="main">
						...
						<p>Record or modify the <strong>Smoking Status</strong> of <%= adminPerson.getLabel() %>.</p>
						...
						<struts-html:form action="/admin/endOfDayReportFilterNew">
							...
							<div class="adminItem">
								<div class="leftTM">SMOKING STATUS</div>
								<div id="radiobuttonsfrommarkup" class="right">
									<div id="buttongroup1" class="yui-buttongroup">
										<input id="radio1" type="radio" name="smoker_status" value="Current Every Day Smoker" />
										<input id="radio2" type="radio" name="smoker_status" value="Current Some Day Smoker" /><br /><br />
										<input id="radio3" type="radio" name="smoker_status" value="Former Smoker" />
										<input id="radio4" type="radio" name="smoker_status" value="Never Smoker" /><br /><br />
										<input id="radio5" type="radio" name="smoker_status" value="Smoker, Current Status Unknown" />
										<input id="radio6" type="radio" name="smoker_status" value="Unknown If Ever Smoked" />
									</div>
								</div>
								<div class="end"></div>
							</div>
...
-->
						...
						<p><strong>Stage 1 Objective</strong><br /> &sect;495.6(d)(9)(i) - Record smoking status for patients 13 years old or older.</p>
						<p><strong>Stage 1 Measure</strong><br /> &sect;495.6(d)(9)(ii) - More than 50% of all unique patients 13 years old or older seen by the EP have smoking status recorded as structured data.<br />&sect;495.6(d)(9)(iii) - Exclusion: Any EP who sees no patients 13 years or older.</p>
						<p><strong>CERTIFICATION CRITERIA</strong> 45 CFR 170.302 & 170.304<br /> &sect;170.302(g) - Smoking status. Enable a user to electronically record, modify, and retrieve the smoking status of a patient. Smoking status types must include: current every day smoker; current some day smoker; former smoker; never smoker; smoker, current status unknown; and unknown if ever smoked.</p>
