...
boolean is_company_admin_for_this_practice = false;

try
{

    // ensure that this person is an admin for this company
    if (adminCompany.isAdministrator(adminPerson))
	is_company_admin_for_this_practice = true;
    else
    {
	if (adminPerson.getDepartment().getCompany().equals(adminCompany))
	{
	    if (adminPerson.hasRole(UKOnlineRoleBean.COMPANY_ADMINISTRATOR_ROLE_NAME))
		is_company_admin_for_this_practice = true;
	}
    }
}
...
<script type="text/javascript">
    ...
    YAHOO.example.init = function () {
        ...
        YAHOO.util.Event.onContentReady("submitbuttonsfrommarkup", function () {
            ...
            var oSubmitButton1 = new YAHOO.widget.Button("submitbutton1", { value: "resume" });
...
<body class=" yui-skin-sam" onload="javascript:initErrors();">
	...
	<div class="content_TextBlock">
	    <p class="headline"><%= adminCompany.getLabel() %> Setup</p>
	...
	<div class="content_Administration">
		...
		<p class="headlineA">Setup Incomplete</p>
		<p><strong>Setup for your Practice has not been completed.</strong></p>
<%
if (!is_company_admin_for_this_practice)
{
%>
		<p>Please contact your administrator to complete the setup process.</p>
<%
}
else
{
%>
		<p>Please click <strong>Resume</strong> to continue the setup process.</p>

		<struts-html:form action="/admin/setupIncomplete" >
			...
			<div id="submitbuttonsfrommarkup" class="right">
			    <input id="submitbutton1" class="formbutton" type="submit" name="submit_button" value="Resume" alt="Resume" style="margin-right: 10px; "/>
			</div>
			<div class="end"></div>
		    </div>
