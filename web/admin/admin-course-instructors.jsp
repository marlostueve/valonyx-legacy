...
<%@ include file="channels\channel-admin-menu.jsp" %>
					...
					<div class="main">
						...
						<p class="headlineA">Activity Details&nbsp;&#47;&nbsp;Instructors</p>
						<p class="currentObjectName"><%= adminCourse.getLabel() %></p>
						<p>Use this screen to add or update the instructor information for this activity.</p>
<p><strong>Note:</strong> To create a new instructor, go to User Manager and select the new instructor's
name, then go to User Roles to define this user as an instructor.</p>
						<div class="horizontalRule"><img src="../images/trspacer.gif" width="1" height="1" alt="" /></div>

						<struts-html:form action="/admin/courseInstructors">

							<input id="dummy" name="dummy" type="hidden" />

							<div class="adminItem">
								<div class="leftTM">INSTRUCTORS</div>
								<div class="right">
									<select name="instructorSelect" class="multipleSelect" style="width: 309px;" size="8" multiple="multiple">
<%
Iterator instructors = UKOnlinePersonBean.getPersons(adminCompany, RoleBean.INSTRUCTOR_ROLE_NAME).iterator();
while (instructors.hasNext())
{
    PersonBean instructor = (UKOnlinePersonBean)instructors.next();
%>
										<option value="<%= instructor.getValue() %>"<%= adminCourse.isInstructor(instructor) ? " selected" : "" %>><%= instructor.getLabel() %></option>
<%
}
%>
									</select>
							...
							<div class="adminItem">
								...
								<div class="right">
									<input class="formbutton" type="submit" value="Assign Instructors" alt="Assign Instructors" />
								</div>
								<div class="end"></div>
							</div>
