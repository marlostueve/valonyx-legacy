...
String pdf_str = XOutStatusReportBuilder.generateReport(adminCompany, (UKOnlinePersonBean)loginBean.getPerson(), cashOut, workstation_cookie.getValue());
...
<div id="center1" style="background-color: white;">
	...
	<div class="content_TextBlock">
	    <p class="headline"><%= adminCompany.getLabel() %> End Of Day - Step 3: X-Out Status Report</p>
...
<!--
		...
		<div class="horizontalRule"><img src="images/trspacer.gif" width="1" height="1" alt="" /></div>
-->
		<struts-html:form action="/admin/eod03">

		    <input type="hidden" name="delete_id" />

		    <div class="adminItem"><strong style="font-weight: bolder;">X-OUT STATUS REPORT</strong></div>
