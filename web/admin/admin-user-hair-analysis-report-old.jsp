...
if (request.getParameter("id") != null)
{
	...
	HairAnalysisRatioWorksheetBuilder builder = new HairAnalysisRatioWorksheetBuilder();
    }
    catch (Exception x)
    {
	x.printStackTrace();
...
<%@ include file="channels\channel-admin-menu.jsp" %>
					...
					<div class="main">
						...
						<p><a href="../resources/pdf/<%= HairAnalysisRatioWorksheetBuilder.generateHairAnalysisRatioWorksheet(mineralRatio) %>" target="_blank">Hair Analysis Ratio Worksheet</a></p>
						<div class="horizontalRule"><img src="../images/trspacer.gif" width="1" height="1" alt="" /></div>
