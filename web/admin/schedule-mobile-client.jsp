	...
	<div id="wrap">
		...
		<div id="sidebar">
			...
			<div class="content">
				...
				<ul class="nav">
					<li><a href="?" class="active"><span class="ico msg"></span>Schedule</a></li>
					<li><a href="schedule-mobile-clients-checked-in.jsp"><span class="ico msg"></span>Checked In<span class="info">&nbsp;2&nbsp;</span></a></li>
