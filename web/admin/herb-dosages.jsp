...
-->
		<struts-html:form action="/admin/inventoryCount" >
			...
			<div class="adminItem">
				<div class="leftTM">HERB MIXTURES</div>
				<div id="directionsContainer" class="right">&nbsp;
				</div>
				<div id="endDiv" class="end"></div>
			</div>

		    <div id="dosageParent" class="content_AdministrationTable" style="width: 566px;" >
			    ...
			    <div class="heading">
				    <table cellspacing="0" cellpadding="0" border="0" summary="">
					    ...
					    <tr style="display: block;">
						    <td style="width:   3px; ">&nbsp;</td>
						    <td style="width:  78px; text-align: center; vertical-align: bottom;  ">Date<br />Mixed</td>
						    <td style="width: 241px; text-align: left; vertical-align: bottom;  ">Herbal<br />Mixture</td>
						    <td style="width: 178px; text-align: center; vertical-align: bottom;  ">Mixer</td>
							<td style="width:  49px; text-align: center; vertical-align: bottom;  ">Days<br />Left</td>
...
<%
try {
	Iterator dosageItr = HerbDosage.getHerbDosages(adminPerson).iterator();
	if (dosageItr.hasNext()) {
		for (int yy = 0; dosageItr.hasNext(); yy++) {
			HerbDosage dosage = (HerbDosage)dosageItr.next();
%>
					<div class="organization">
						<table cellspacing="" cellpadding="" border="0" summary="">
							<tr>
								...
								<td style="width:  14px; text-align: center;  "><img src="../images/delete_icon.gif" title="Delete" onclick="if (confirm('Delete?')) {processCommand('deleteHerbDosage','<%= dosage.getId() %>')}" ></td>
								<td style="width:   3px; ">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:   3px; ">&nbsp;</td>
								<td style="width: 560px; text-align: left; " colspan="5" ><%= dosage.getNotes().replaceAll("\\|", "<br />") %></td>
								<td style="width:   3px; ">&nbsp;</td>
							</tr>
						</table>
					</div>
					...
					<div class="organization">
						<table cellspacing="" cellpadding="" border="0" summary="">
							<tr>
								...
								<td style="width: 241px; text-align: left;  ">-</td>
					...
					<div class="organization">
						<table cellspacing="" cellpadding="" border="0" summary="">
							<tr>
								...
								<td style="width: 241px; text-align: left; font-weight: bolder;  ">No Mixtures Found</td>
