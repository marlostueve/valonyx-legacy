    ...
    <div id="center1" style="background-color: white;">
		...
		<div id="content">
			...
			<div class="content_TextBlock">
				<p class="headline"><%= adminCompany.getLabel() %> - Clients - <span id="selectedPerson"><%= adminPerson.isNew() ? "No Client Selected" : adminPerson.getLabel() %></span> - EHR - Demographics </p>
...
<%@ include file="channels/channel-client-menu.jsp" %>
				...
				<div class="main">
						...
						<p>Record or modify the <strong>demographics</strong> for <%= adminPerson.getLabel() %>.</p>
						...
						<struts-html:form action="/admin/endOfDayReportFilterNew">
							...
							<div class="adminItem">
								<div class="leftTM">PREFERRED LANGUAGE</div>
								<div class="right">
								      <input type="text" class="inputbox" id="preferred_language" name="preferred_language" style="width: 164px;" value="" />
								</div>
								<div class="end"></div>
							</div>
									  
							<div class="adminItem">
								<div class="leftTM">GENDER</div>
							...
							<div class="adminItem">
								<div class="leftTM">RACE</div>
								<div class="right">
								      <input type="text" class="inputbox" id="race" name="race" style="width: 164px;" value="" />
								</div>
								<div class="end"></div>
							</div>

							<div class="adminItem">
								<div class="leftTM">ETHNICITY</div>
								<div class="right">
								      <input type="text" class="inputbox" id="ethnicity" name="ethnicity" style="width: 164px;" value="" />
								</div>
								<div class="end"></div>
							</div>
							...
							<div class="adminItem">
								...
								<div class="right">
								      <input type="text" class="inputbox" id="start_date" name="start_date" style="width: 64px;" value="<%= CUBean.getUserDateString(now.getTime()) %>" />
...
-->
						...
						<p><strong>Stage 1 Objective</strong><br /> &sect;495.6(d)(7)(i) - Record all of the following demographics:<br />
(A) Preferred language.<br />
(B) Gender.<br />
(C) Race.<br />
(D) Ethnicity.<br />
(E) Date of birth.</p>
						<p><strong>Stage 1 Measure</strong><br /> &sect;495.6(d)(7)(ii) - More than 50% of all unique patients seen by the EP have demographics recorded as structured data.</p>
						<p><strong>CERTIFICATION CRITERIA</strong> 45 CFR 170.302 & 170.304<br /> &sect;170.304(c) - Record demographics.  Enable a user to electronically record, modify, and retrieve patient demographic data including preferred language, gender, race, ethnicity, and date of birth. Enable race and ethnicity to be recorded in accordance with the standard specified at §170.207(f).</p>
