...
try
{
	...
	String report_label = "Goods Sold Report";
	...
	while (orders_x_itr.hasNext())
	{
		...
		if (orderline_cost == null)
		{
			...
			if (checkout_code.getId() == 21)
				System.out.println("orderline_cost A >" + orderline_cost.toString());
		}
		...
		if (checkout_code.getId() == 21)
			System.out.println("orderline_cost B >" + orderline_cost.toString());
					...
					<div class="heading">
						<table cellspacing="0" cellpadding="0" border="0" summary="">
							<tr style="display: block;">
								<td style="width: 300px; text-align: left;  "><a href="report-goods-sold.jsp?sort=<%= (courseReportLister.getSort() == (short)1) ? 2 : 1  %>" title="">Description</a></td>
								<td style="width:  66px; text-align: left;  "><a href="report-goods-sold.jsp?sort=<%= (courseReportLister.getSort() == (short)3) ? 4 : 3  %>" title="">Qty</a></td>
								<td style="width:  66px; text-align: left;  "><a href="report-goods-sold.jsp?sort=<%= (courseReportLister.getSort() == (short)15) ? 16 : 15  %>" title="">Total Cost</a></td>
								<td style="width:  66px; text-align: left;  "><a href="report-goods-sold.jsp?sort=<%= (courseReportLister.getSort() == (short)15) ? 16 : 15  %>" title="">Avg. Cost</a></td>
								<td style="width:  66px; text-align: left;  "><a href="report-goods-sold.jsp?sort=<%= (courseReportLister.getSort() == (short)15) ? 16 : 15  %>" title="">Total Sales</a></td>
								<td style="width:  66px; text-align: left;  "><a href="report-goods-sold.jsp?sort=<%= (courseReportLister.getSort() == (short)15) ? 16 : 15  %>" title="">Avg. Sale</a></td>
