...
<script type="text/javascript">
    ...
    YAHOO.example.init = function () {
	    ...
	    var oSubmitButton2 = new YAHOO.widget.Button("submitbutton2", { value: "agree" });
        });
...
initBrowser()
{
	...
	//alert(document.forms[0].browser);
}
...
<body class=" yui-skin-sam" onload="javascript:initBrowser();">
...
<div id="center1" style="background-color: white;">
	...
	<div class="content_TextBlock">
	    <p class="headline">Terms of Service Agreement</p>
...
-->
			...
			<div class="adminItem">Please review the terms of service and the click <strong>Agree</strong> to proceed, or <strong>Cancel</strong> to exit.</div>
		    <div class="adminItem">If the terms of service doesn't appear below, or if you'd like to save a copy, <a href="../resources/pdf/ValonyxTermsOfService.pdf" target="_blank">click here</a> to download.</div>

		    <div class="adminItem">
				<EMBED SRC="../resources/pdf/ValonyxTermsOfService.pdf" WIDTH="745" HEIGHT="450"></EMBED>
		    </div>
			...
			<div id="submitbuttonsfrommarkup" class="right">
				<struts-html:form action="/admin/termsOfService">
					<input id="submitbutton1" class="formbutton" type="submit" name="submit_button" value="Cancel" alt="Cancel" style="margin-right: 10px; "/>
					<input id="submitbutton2" class="formbutton" type="submit" name="submit_button" value="Agree" alt="Agree" style="margin-right: 10px; "/>
