...
adminMarketingPlan = new MarketingPlan();
...
%>
    ...
    <div id="content">
				...
				<div class="content_TextBlock">
					<p class="headline"><%= adminCompany.getLabel() %> Administration - Add New Marketing Campaign</p>
...
<%@ include file="channels\channel-setup-menu.jsp" %>
					...
					<div class="main">
						...
						<p>Use this screen to add a new marketing campaign.</p>
						<div class="horizontalRule"><img src="../images/trspacer.gif" width="1" height="1" alt="" /></div>
						...
						<struts-html:form action="/admin/newMarketingPlan" focus="nameInput" >
							...
							<div class="adminItem">
								...
								<div class="right">
									<label for="activeId">This is a bulk email campaign</label>
									<input name="isBulkEmailInput" id="activeId" type="checkbox" class="crirHiddenJS"<%= adminMarketingPlan.isBulkEmail() ? " checked=\"checked\"" : "" %>/>
								</div>
								<div class="end"></div>
							</div>
							...
							<div class="adminItem">
								...
								<div class="right">
									<input class="formbutton" type="submit" value="&nbsp;Add New Marketing Plan&nbsp;" alt="Add New Marketing Plan" /><input type="hidden" name="delete_id" value="0" />
								</div>
								<div class="end"></div>
							</div>
