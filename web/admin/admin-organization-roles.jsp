...
<jsp:useBean id="adminRole" class="com.badiyan.uk.beans.RoleBean" scope="session" />
...
<%
String stepString = "Step 5: Roles";

if (request.getParameter("id") != null)
{
    try
    {
        RoleBean role_obj = RoleBean.getRole(Integer.parseInt(request.getParameter("id")));
        CompanyBean company_obj = role_obj.getCompany();
...
<%@ include file="channels\channel-organization-menu.jsp" %>
			...
			<TABLE WIDTH=522 BORDER=0 CELLPADDING=1 CELLSPACING=0 BGCOLOR="#BBBBBB">
				<TR HEIGHT=26>
					<TD ALIGN=left BACKGROUND="../images/PttrsnUK_TableHeaderBG2.jpg"><P style="font-size: 13pt; font-family: Arial; font-weight: bold; color: #000000;">&nbsp;Role</P></TD>
				</TR>
				<TR>
					<TD>
						<TABLE WIDTH=520 BORDER=0 CELLPADDING=1 CELLSPACING=0 BGCOLOR="#FFFFFF">
                                                <struts-html:form action="/admin/organizationRoles" focus="nameInput">
							...
							<TR HEIGHT=30>
								...
								<TD>
                                                                    <input type="text" name="nameInput" value="<%= adminRole.getLabel() %>" style="font-size: 13px; width: 400px;">
								</TD>
							</TR>
							<TR HEIGHT=2>
								<TD ALIGN=left COLSPAN=2><IMG SRC="../images/trspacer.gif" WIDTH=1 HEIGHT=1 ALT=""></TD>
							...
							<TR HEIGHT=30>
								<TD ALIGN=right COLSPAN=2><INPUT TYPE="submit" NAME="create" VALUE="<%= (adminRole.isNew()) ? "Create" : "Save" %> Role"><IMG SRC="../images/trspacer.gif" WIDTH=12 HEIGHT=1 ALT=""></TD>
							</TR>
							<TR HEIGHT=2>
								<TD ALIGN=left COLSPAN=2><IMG SRC="../images/trspacer.gif" WIDTH=1 HEIGHT=1 ALT=""></TD>
							</TR>
			...
			<TABLE WIDTH=522 BORDER=0 CELLPADDING=1 CELLSPACING=0 BGCOLOR="#6F9BCB">
				<TR HEIGHT=26>
					<TD ALIGN=left BACKGROUND="../images/PttrsnUK_TableHeaderBG3.jpg"><P style="font-size: 13pt; font-family: Arial; font-weight: bold; color: #000000;">&nbsp;Roles</P></TD>
				</TR>
				<TR>
					<TD>
						<TABLE WIDTH=520 BORDER=0 CELLPADDING=1 CELLSPACING=0 BGCOLOR="#FFFFFF">
...
try
{
    Iterator roles = RoleBean.getRoles(adminCompany).iterator();
    while (roles.hasNext())
    {
        RoleBean obj = (RoleBean)roles.next();
%>
