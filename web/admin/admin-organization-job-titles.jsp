...
<jsp:useBean id="adminJobTitle" class="com.badiyan.uk.beans.PersonTitleBean" scope="session" />
...
if (request.getParameter("id") != null)
{
    try
    {
        PersonTitleBean person_title_obj = PersonTitleBean.getPersonTitle(Integer.parseInt(request.getParameter("id")));
        CompanyBean company_obj = person_title_obj.getCompany();
        ...
        if (company_obj.isAdministrator(loginBean.getPerson()))
        {
            ...
            adminJobTitle = person_title_obj;
            session.setAttribute("adminJobTitle", adminJobTitle);
        }
    }
    catch (Exception x)
    {
...
{
    adminJobTitle = new PersonTitleBean();
    session.setAttribute("adminJobTitle", adminJobTitle);
}
...
<%@ include file="channels\channel-admin-menu.jsp" %>
					...
					<div class="main">
						...
						<p class="headlineA">Organization Profile&nbsp;&#47;&nbsp;Job Titles</p>
						<p class="currentObjectName"><%= adminCompany.getLabel() %></p>
						<p>Use this screen to add a new job title or update an existing one.</p>
						<div class="horizontalRule"><img src="../images/trspacer.gif" width="1" height="1" alt="" /></div>

						<struts-html:form action="/admin/organizationJobTitles" focus="nameInput">
							...
							<div class="adminItem">
								...
								<div class="right">
									<input name="nameInput" onfocus="select();" value="<%= adminJobTitle.getLabel() %>" size="31" maxlength="100" class="inputbox" style="width: 206px; margin-right: 4px;" />
							...
							<div class="heading">
								<table cellspacing="0" cellpadding="0" border="0" summary="">
									<tr style="display: block;">
										...
										<td style="width: 402px; text-align: left;  ">Job Title</td>
...
%>
							...
							<div class="jobTitle">
								<table cellspacing="0" cellpadding="0" border="0" summary="">
									<tr>
										<td style="width:  20px; text-align: left;  "></td>
										<td style="width: 402px; text-align: left;  "><a href="admin-organization-job-titles.jsp?id=<%= obj.getValue() %>" title=""><%= obj.getLabel() %></a></td>
...
%>
							...
							<div class="jobTitle">
								<table cellspacing="0" cellpadding="0" border="0" summary="">
									<tr>
										<td style="width: 492px; text-align: left;  " colspan="3">No Job Titles Found</td>
									</tr>
								</table>
							</div>
							<!-- END Job Title -->
