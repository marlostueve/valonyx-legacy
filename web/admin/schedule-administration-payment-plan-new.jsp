...
<%@ include file="channels\channel-setup-menu.jsp" %>
				...
				<div class="main">
						...
						<struts-html:form action="/admin/newPlan" focus="nameInput" >
							...
							<div class="adminItem">
								...
								<div class="right">
									<input name="nameInput" onfocus="select();" value="" size="31" maxlength="255" class="inputbox" style="width: 206px;" />
								</div>
								<div class="end"></div>
							</div>
							<div class="adminItem">
								...
								<div class="right">
									<select name="typeSelect" style="width: 304px;">
										...
										<option value="<%= PaymentPlanBean.CASH_BILLING_TYPE %>">Cash Plan</option>
										<option value="<%= PaymentPlanBean.THIRD_PARTY_INSURANCE_BILLING_TYPE %>">3rd Party Insurance Billing (Beacon)</option>
										<option value="<%= PaymentPlanBean.DIRECT_INSURANCE_BILLING_TYPE %>">Direct Insurance Billing</option>
									</select>
								</div>
								<div class="end"></div>
							</div>
...
%>
							...
							<div class="adminItem">
								...
								<div class="right">
									<input name="costInput" onfocus="select();" value="" size="31" maxlength="10" class="inputbox" style="width: 64px;" />
								</div>
								<div class="end"></div>
							</div>
							<div class="adminItem">
								...
								<div class="right">
									<input name="visitsInput" onfocus="select();" value="" size="31" maxlength="3" class="inputbox" style="width: 64px;" />
								</div>
								<div class="end"></div>
							</div>
							<div class="adminItem">
								...
								<div class="right">
									...
									<input name="allowMonthlyPayments" id="allowMonthlyPaymentsId" type="checkbox" class="crirHiddenJS" checked="checked"/>
								</div>
								<div class="end"></div>
							</div>
							<div class="adminItem">
								...
								<div class="right">
									<input name="monthsInput" onfocus="select();" value="" size="31" maxlength="3" class="inputbox" style="width: 64px;" />
								</div>
								<div class="end"></div>
							</div>
							<div class="adminItem">
								...
								<div class="right">
									...
									<input name="allowPooling" id="allowPoolingId" type="checkbox" class="crirHiddenJS" checked="checked"/>
								</div>
								<div class="end"></div>
							</div>
							<div class="adminItem">
								...
								<div class="right">
									<input class="formbutton" type="submit" value="Add New Payment Plan" alt="Add New Payment Plan" /><input type="hidden" name="delete_id" value="0" />
								</div>
								<div class="end"></div>
							</div>
