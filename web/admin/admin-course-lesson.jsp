...
if (request.getParameter("id") != null)
{
    try
    {
        String group_id_string = request.getParameter("id");
	adminCourseGroup = CourseGroupBean.getCourseGroup(Integer.parseInt(group_id_string));
...
<%@ include file="channels\channel-admin-menu.jsp" %>
					...
					<div class="main">
						...
						<p class="headlineA">Curriculum Level Details</p>
						<p>Use this screen to manage the curriculum level.</p>
						...
						<struts-html:form action="/admin/courseLesson">
							...
							<div class="adminItem">
								...
								<div class="right">
									<input class="formbutton" type="submit" name="button" value="Update" alt="Update" style="margin-right: 4px;" onclick="javascript:document.forms[0].delete_id.value=0;"/>
									<input class="formbutton" type="submit" name="button" value="Delete" alt="Delete" style="margin-right: 4px;" onclick="javascript:document.forms[0].delete_id.value=<%= adminCourseGroup.getId() %>;return confirm('Are you sure?');"/>
