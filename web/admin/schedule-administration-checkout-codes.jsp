    ...
    */
    ...
    function showCodes(xml_str)
    {
        ...
        while (xml_str.getElementsByTagName("code")[index] != null)
        {
			...
			addItemRow(key, codeArr["desc"], codeArr["type"], codeArr["pa"], codeArr["dept"], codeArr["com"], codeArr["sync"]);
	...
	function addItemRow(code_id, code, type, pa, dept, com, sync)
	{
		...
		*/
		...
		if (com == 'X') {
			img4.setAttribute('src', 'images/icon_check.gif');
			img4.setAttribute('title', 'Commissionable');
		} else {
			img4.setAttribute('src', 'images/spacer.gif');
			img4.setAttribute('title', 'Not Commissionable');
		}
...
<%
if (adminCompany.getQuickBooksSettings().isQuickBooksFSEnabled()) {
%>
		// cell 5 - text
		...
		if (sync == 'X') {
			img5.setAttribute('src', 'images/wht_sync.gif');
			img5.setAttribute('title', 'Synchronized with QB');
		}
		else {
			img5.setAttribute('src', 'images/exclamation.gif');
			img5.setAttribute('title', 'Not synchronized with QB');
		}
...
%>
	...
	<div class="content_TextBlock">
	    <p class="headline"><%= adminCompany.getLabel() %> Administration - Inventory & Procedures</p>
	...
	<div class="content_Administration">
	    ...
	    <div class="main" style="width: 592px;">
<!--
		<p class="headlineA"></p>
...
-->
		<struts-html:form action="/admin/inventoryCount" >
			...
			<div class="adminItem">
				...
				<div class="right">
					<input onkeyup="if (this.value.length > 1) { processCommand('getCheckoutCodesByDescInv', document.forms[0].searchInput.value + '|' + this.value); }" name="vendorSearchInput" value="<%= vendor_search_str %>" onfocus="select();" class="inputbox" style="width: 164px;" />
				</div>
				<div class="end"></div>
			</div>
			    ...
			    <div class="heading">
				    <table cellspacing="0" cellpadding="0" border="0" summary="">
					    ...
					    <tr style="display: block;">
						    ...
						    <td style="width: 232px; text-align: left;  ">Item</td>
						    <td style="width:  70px; text-align: left;  ">Type</td>
						    <td style="width:  90px; text-align: left;  ">Practice Area</td>
						    <td style="width:  69px; text-align: left;  ">Dept</td>
						    <td style="width:  40px; text-align: left;  ">Comm</td>
<%
if (adminCompany.getQuickBooksSettings().isQuickBooksFSEnabled()) {
%>
						    <td style="width:  40px; text-align: left;  ">Synced</td>
<%
}
%>
			    ...
			    <div class="organization">
				    <table id="inventory-table" cellspacing="" cellpadding="" border="0" summary="">
					    <tr>
						    <td style="width:   3px; text-align: left;  ">&nbsp;</td>
						    <td style="width: 232px; text-align: left;  ">Search To Find Items</td>
