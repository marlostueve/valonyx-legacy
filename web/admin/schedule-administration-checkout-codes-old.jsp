...
<%@ include file="channels\channel-setup-menu.jsp" %>
				...
				<div class="main">
				    ...
				    <p>Use this screen to manage inventory.</p>
					...
					<div class="heading">
						<table cellspacing="0" cellpadding="0" border="0" summary="">
							...
							<td style="width:  50px; text-align: left;  ">Code</td>
							<td style="width: 222px; text-align: left;  ">Description</td>
							<td style="width: 100px; text-align: left;  ">Type</td>
							<td style="width: 100px; text-align: left;  ">Practice Area</td>
						</tr>
						</table>
					</div>
					<div class="horizontalRule"><img src="images/trspacer.gif" width="1" height="1" alt="" /></div>
...
<%
Iterator itr = CheckoutCodeBean.getCheckoutCodes(adminCompany).iterator();
if (itr.hasNext())
{
    while (itr.hasNext())
    {
...
%>
					...
					<div class="organization">
						<table cellspacing="0" cellpadding="0" border="0" summary="">
							<tr>
								<td style="width:  20px; text-align: left;  "></td>
								<td style="width:  50px; text-align: left;  "><%= code.getCode() %></td>
								<td style="width: 222px; text-align: left;  "><a href="schedule-administration-checkout-code.jsp?id=<%= code.getValue() %>" title=""><%= code.getLabel() %></a></td>
								<td style="width: 100px; text-align: left;  "><%= type_str %></td>
								<td style="width: 100px; text-align: left;  "><%= practice_area_str %></td>
							</tr>
						</table>
					</div>
...
%>
					<div class="organization">
						<table cellspacing="0" cellpadding="0" border="0" summary="">
							<tr>
								<td style="width:  20px; text-align: left;  "></td>
								<td colspan="4" style="width: 472px; text-align: left;  ">No Checkout Codes Found</td>
							</tr>
						</table>
					</div>
<%
