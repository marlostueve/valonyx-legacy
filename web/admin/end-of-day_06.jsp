...
session.setAttribute("eod_06", "true");
...
String pdf_str = ZOutStoreCloseReportBuilder.generateReport(adminCompany, (UKOnlinePersonBean)loginBean.getPerson(), cashOut, workstation_cookie.getValue());
...
<div id="center1" style="background-color: white;">
	...
	<div class="content_TextBlock">
	    <p class="headline"><%= adminCompany.getLabel() %> End Of Day - Step 6: Z-Out Store Close Report</p>
...
<!--
		...
		<div class="horizontalRule"><img src="images/trspacer.gif" width="1" height="1" alt="" /></div>
-->
		<struts-html:form action="/admin/eod06">

		    <input type="hidden" name="delete_id" />

		    <div class="adminItem"><strong style="font-weight: bolder;">Z-OUT STORE CLOSE REPORT</strong></div>
