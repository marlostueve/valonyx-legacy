...
%>
    ...
    <div id="content">
				...
				<div class="content_TextBlock">
					<p class="headline"><%= adminCompany.getLabel() %> Administration - Send Bulk Email</p>
...
<%@ include file="channels\channel-setup-menu.jsp" %>
					...
					<div class="main">
						...
						<p>Use this screen to send bulk emails.  HTML emails are supported.</p>
						<div class="horizontalRule"><img src="../images/trspacer.gif" width="1" height="1" alt="" /></div>

						<struts-html:form action="/admin/sendBulkEmail" focus="nameInput" >

							<input id="dummy" name="dummy" type="hidden" />
							
							<div class="adminItem">
								<div class="leftTM">EMAIL SUBJECT</div>
								<div class="right">
									<input name="nameInput" onfocus="select();"  size="31" maxlength="100" class="inputbox" style="width: 306px;" />
								</div>
								<div class="end"></div>
							</div>
							
							<div class="adminItem">
								<div class="leftTM">EMAIL BODY</div>
								<div class="right">
									<textarea name="emailInput" rows="12"  style="width: 406px;"></textarea>
								</div>
								<div class="end"></div>
							</div>
							...
							<div class="adminItem">
								...
								<div class="right">
									<label for="allId">Send to all clients</label>
									<input name="isAllClientsInput" id="allId" type="checkbox" />
								</div>
								<div class="end"></div>
							</div>
							...
							<div class="adminItem">
								...
								<div class="right">
									<input class="formbutton" type="submit" value="&nbsp;Send Email&nbsp;" alt="Send Email" />
								</div>
								<div class="end"></div>
							</div>
