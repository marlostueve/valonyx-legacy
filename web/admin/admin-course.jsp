...
<%@ include file="channels\channel-admin-menu.jsp" %>
					...
					<div class="main">
						...
						<p class="headlineA">Course Details</p>
						<p>Use this screen to add or update details for a course.</p>
<p>If a course is not appearing on users' screens, check the Status, Released, and Expires
fields. If you make changes, click <strong>Update Course.</strong></p>
						<div class="horizontalRule"><img src="../images/trspacer.gif" width="1" height="1" alt="" /></div>

						<struts-html:form action="/admin/courseBasic" focus="titleInput" onsubmit="return validateCourseBasicForm(this);">
...
%>
									<option value="<%= course_group.getValue() %>"<%= adminCourse.getCourseGroupIdString().equals(course_group.getValue()) ? " selected" : "" %>><%= course_group.getLabel() %></option>
<%
}
%>
								    </select>
...
%>
							...
							<p>
								...
								<input class="formbutton" type="submit" value="Update Course" alt="Update Course" />
								<input type="hidden" name="typeSelect" value="Course">
							</p>
