...
<%@ include file="channels\channel-admin-menu.jsp" %>
					...
					<div class="main">
						...
						<p class="headlineA">Activity Details&nbsp;&#47;&nbsp;Prerequisites</p>
						<p class="currentObjectName"><%= adminCourse.getLabel() %></p>
						<p>Use this screen to update or assign prerequisites to an activity. You may select multiple
activities by holding the Ctrl or Shift keys while clicking. The current prerequisites for this
activity are listed in the table at the bottom, including their type and release date.</p>

						<struts-html:form action="/admin/coursePrerequisite">

							<input id="dummy" name="dummy" type="hidden" />

							<p>
								<select name="activities" class="multipleSelect" size="8" multiple="multiple" style="width: 492px;">
<%
if (has_courses_x)
{
...
%>
							...
							<p style="margin-top: 20px; ">
								<input class="formbutton" type="submit" value="Update Prerequisites" alt="Update Prerequisites" />
							</p>
...
%>
							...
							<div class="certification">
								<table cellspacing="0" cellpadding="0" border="0" summary="">
									<tr>
										<td style="width: 492px; text-align: left;  " colspan="4">No Prerequisites Found</td>
									</tr>
								</table>
							</div>
							<!-- END Course -->
