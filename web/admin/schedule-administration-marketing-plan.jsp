...
<jsp:useBean id="adminMarketingPlan" class="com.badiyan.uk.online.beans.MarketingPlan" scope="session" />
...
{
	adminMarketingPlan = MarketingPlan.getMarketingPlan(Integer.parseInt(request.getParameter("id")));
	session.setAttribute("adminMarketingPlan", adminMarketingPlan);
}
%>
...
%>
    ...
    <div id="content">
				...
				<div class="content_TextBlock">
					<p class="headline"><%= adminCompany.getLabel() %> Administration - Marketing Campaign</p>
...
<%@ include file="channels\channel-setup-menu.jsp" %>
					...
					<div class="main">
						...
						<p>Use this screen to update a marketing campaign.</p>
						<div class="horizontalRule"><img src="../images/trspacer.gif" width="1" height="1" alt="" /></div>

						<struts-html:form action="/admin/newMarketingPlan" focus="nameInput" >

							<input id="dummy" name="dummy" type="hidden" />
							
							<div class="adminItem">
								<div class="leftTM">MARKETING CAMPAIGN NAME</div>
								<div class="right">
									<input name="nameInput" onfocus="select();" value="<%= adminMarketingPlan.getNameString() %>" size="31" maxlength="100" class="inputbox" style="width: 206px;" />
								</div>
								<div class="end"></div>
							</div>

							<div class="adminItem">
								<div class="leftTM">ACTIVE</div>
								<div class="right">
									<label for="activeId">This is an active marketing campaign</label>
									<input name="activeInput" id="activeId" type="checkbox" <%= adminMarketingPlan.isActive() ? " checked=\"checked\"" : "" %>/>
								</div>
								<div class="end"></div>
							</div>

							<div class="adminItem">
								<div class="leftTM">BULK EMAIL</div>
								<div class="right">
									<label for="bulkEmailId">This is a bulk email campaign</label>
									<input name="isBulkEmailInput" id="bulkEmailId" type="checkbox" <%= adminMarketingPlan.isBulkEmail() ? " checked=\"checked\"" : "" %>/>
								</div>
								<div class="end"></div>
							</div>

							<p>Specify the start and end date for the marketing campaign.  These fields are optional if the campaign doesn't expire.</p>

							<div class="adminItem">
								<div class="leftTM">START DATE *</div>
								<div class="right">
									<input name="startDate" onfocus="getDate('newMarketingPlanForm','startDate');select();" value="<%= adminMarketingPlan.getStartDateString() %>" size="31" maxlength="10" style="width: 70px;" />
								</div>
								<div class="end"></div>
							</div>
							...
							<div class="adminItem">
								...
								<div class="right">
									<input name="endDate" onfocus="getDate('newMarketingPlanForm','endDate');select();" value="<%= adminMarketingPlan.getEndDateString() %>" size="31" maxlength="10" style="width: 70px;" />
								</div>
								<div class="end"></div>
							</div>
							...
							<div class="adminItem">
								...
								<div class="right">
									<input class="formbutton" type="submit" value="&nbsp;Update Marketing Plan&nbsp;" alt="Update Marketing Plan" /><input type="hidden" name="delete_id" value="0" />
								</div>
								<div class="end"></div>
							</div>
