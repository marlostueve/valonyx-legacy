...
<jsp:useBean id="emailList" class="com.badiyan.uk.online.beans.EmailList" scope="session" />
...
%>
    ...
    <div id="content">
				...
				<div class="content_TextBlock">
					<p class="headline"><%= adminCompany.getLabel() %> Administration - Add New Email List</p>
...
<%@ include file="channels\channel-setup-menu.jsp" %>
					...
					<div class="main">
						...
						<p>Use this screen to add a new email list.</p>
						<div class="horizontalRule"><img src="../images/trspacer.gif" width="1" height="1" alt="" /></div>

						<struts-html:form action="/admin/newEmailList" focus="nameInput" >

							<input id="dummy" name="dummy" type="hidden" />
							
							<div class="adminItem">
								<div class="leftTM">EMAIL LIST NAME</div>
								<div class="right">
									<input name="nameInput" onfocus="select();" value="<%= emailList.getNameString() %>" size="31" maxlength="100" class="inputbox" style="width: 206px;" />
								</div>
								<div class="end"></div>
							</div>
							...
							<div class="adminItem">
								...
								<div class="right">
									<label for="activeId">This email list is active</label>
									<input name="isBulkEmailInput" id="activeId" type="checkbox" <%= emailList.isActive() ? " checked=\"checked\"" : "" %>/>
								</div>
								<div class="end"></div>
							</div>

							<div class="adminItem">
								<div class="leftTM">ALL CLIENTS</div>
								<div class="right">
									<label for="allId">Include all clients in this list</label>
									<input name="isAllClientsInput" id="allId" type="checkbox" <%= emailList.isActive() ? " checked=\"checked\"" : "" %>/>
								</div>
								<div class="end"></div>
							</div>
