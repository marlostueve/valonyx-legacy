...
// find the wellness survey assessment for this company...

try {
	adminAssessment = AssessmentBean.getAssessment(adminCompany, "Client Wellness Survey");
} catch (com.badiyan.uk.exceptions.ObjectNotFoundException x) {
	// doesn't exist -  need to create
	adminAssessment = new AssessmentBean();
	adminAssessment.setName("Client Wellness Survey");
...
%>
	...
	<div class="content_TextBlock">
	    <p class="headline"><%= adminCompany.getLabel() %> <%= settings.isSetupComplete() ? "Administration" : "Setup" %> - Client Wellness Survey</p>
...
%>
						...
						<struts-html:form action="/admin/wellnessFITBQuestion" focus="questionInput">
...
%>
						...
						<struts-html:form action="/admin/wellnessQuestion" onsubmit="return validateAssessmentQuestionForm(this);">
...
if (stems.size() > 0)
{
	...
	System.out.println("STEM TASTIC >" + stem.getLabel());
...
%>
							...
							<div class="question">
								<table cellspacing="0" cellpadding="0" border="0" summary="">
									<tr>
										<td style="width:  20px; text-align: left;  "></td>
										<td style="width: 322px; text-align: left;  "><a href="schedule-administration-client-wellness-survey.jsp?id=<%= adminAssessment.getId() %>&stemId=<%= stem.getId() %>" title=""><%= stem.getNameString() %></a></td>
										<td style="width:  50px; text-align: center;  "><a href="schedule-administration-client-wellness-survey.jsp?moveUpId=<%= stem.getId() %>" title="Move Up">Up</a></td>
										<td style="width:  30px; text-align: center;  "><a href="schedule-administration-client-wellness-survey.jsp?moveDownId=<%= stem.getId() %>" title="Move Down">Down</a></td>
										<td style="width:  70px; text-align: center;  "><a href="javascript:if (confirm('<struts-bean:message key="confirm" />')) {document.location.href='schedule-administration-client-wellness-survey.jsp?deleteId=<%= stem.getId() %>'}" title="Delete">Delete</a></td>
									</tr>
								</table>
							</div>
							<!-- END Question -->
...
%>
							...
							<div class="question">
								<table cellspacing="0" cellpadding="0" border="0" summary="">
									<tr>
										<td style="width:  20px; text-align: left;  "></td>
										<td style="width: 322px; text-align: left;  "><a href="schedule-administration-client-wellness-survey.jsp?id=<%= adminAssessment.getId() %>&stemId=<%= stem.getId() %>" title=""><%= stem.getNameString() %></a><%= stem.isCheckAllThatApply() ? " (check all that apply)" : "" %></td>
										<td style="width:  50px; text-align: center;  "><a href="schedule-administration-client-wellness-survey.jsp?moveUpId=<%= stem.getId() %>" title="Move Up">Up</a></td>
										<td style="width:  30px; text-align: center;  "><a href="schedule-administration-client-wellness-survey.jsp?moveDownId=<%= stem.getId() %>" title="Move Down">Down</a></td>
										<td style="width:  70px; text-align: center;  "><a href="javascript:if (confirm('<struts-bean:message key="confirm" />')) {document.location.href='schedule-administration-client-wellness-survey.jsp?deleteId=<%= stem.getId() %>'}" title="Delete">Delete</a></td>
									</tr>
							...
							<div class="question">
								<table cellspacing="0" cellpadding="0" border="0" summary="">
									<tr>
										<td style="width:  20px; text-align: left;  "></td>
										<td style="width: 322px; text-align: left;  "><a href="schedule-administration-client-wellness-survey.jsp?id=<%= adminAssessment.getId() %>&stemId=<%= stem.getId() %>" title=""><%= stem.getNameString() %></a></td>
										<td style="width:  50px; text-align: center;  "><a href="schedule-administration-client-wellness-survey.jsp?moveUpId=<%= stem.getId() %>" title="Move Up"><struts-bean:message key="admin.button14" /></a></td>
										<td style="width:  30px; text-align: center;  "><a href="schedule-administration-client-wellness-survey.jsp?moveDownId=<%= stem.getId() %>" title="Move Down"><struts-bean:message key="admin.button15" /></a></td>
										<td style="width:  70px; text-align: center;  "><a href="schedule-administration-client-wellness-survey.jsp?deleteId=<%= stem.getId() %>" title="Delete"><struts-bean:message key="admin.button07" /></a></td>
									</tr>
								</table>
							</div>
<%
