...
%>
    ...
    <div id="content">
				...
				<div class="content_TextBlock">
					<p class="headline"><%= adminCompany.getLabel() %> Administration - Email Lists</p>
...
<%@ include file="channels\channel-setup-menu.jsp" %>
					...
					<div class="main">
						...
						<p>Use this screen to manage your email lists.</p>
							...
							<div class="heading">
								<table cellspacing="0" cellpadding="0" border="0" summary="">
									...
									<tr style="display: block;">
										...
										<td style="width: 352px; text-align: left;  ">Email List</td>
...
try {
	Iterator itr = EmailList.getEmailLists(adminCompany).iterator();
	if (itr.hasNext())
	{
		while (itr.hasNext())
		{
			EmailList email_list = (EmailList)itr.next();
...
%>
							...
							<div class="organization">
								<table cellspacing="0" cellpadding="0" border="0" summary="">
									<tr>
										<td style="width:  20px; text-align: left;  "></td>
										<td style="width: 352px; text-align: left;  "><a href="schedule-administration-email-list.jsp?id=<%= email_list.getValue() %>" title=""><%= email_list.getLabel() %></a></td>
										<td style="width:  70px; text-align: left;  ">99</td>
										<td style="width:  50px; text-align: left;  "><%= email_list.isActive() %></td>
									</tr>
								</table>
							</div>
							<!-- END Marketing Plan -->
...
%>
							<div class="organization">
								<table cellspacing="0" cellpadding="0" border="0" summary="">
									<tr>
										<td style="width:  20px; text-align: left;  "></td>
										<td colspan="3" style="width: 472px; text-align: left;  ">No Email Lists Found</td>
									</tr>
								</table>
							</div>
<%
