...
<%
StringBuffer results = (StringBuffer)session.getAttribute("export_results");
%>
...
<%@ include file="channels\channel-admin-menu.jsp" %>
					...
					<div class="main">
						...
						<p class="headlineA">Export Activity Results</p>
						<p>Export Results:</p>
						<div class="horizontalRule"><img src="../images/trspacer.gif" width="1" height="1" alt="" /></div>

						<p><a href="../resources/autorun.inf">autorun.inf</a><br /><a href="../resources/activity-install.exe">activity-install.exe</a><br /><%= results.toString() %></p>
