    ...
    <div id="center1" style="background-color: white;">
		...
		<div id="content">
			...
			<div class="content_TextBlock">
				<p class="headline"><%= adminCompany.getLabel() %> Administration - End of Day Report</p>
...
button on your browser.</p>
						...
						<struts-html:form action="/admin/endOfDayVisitFilterNew">
							...
							<div class="adminItem">
								...
								<input id="submitbutton1" class="formbutton" type="submit" name="submit_button" value="View Report" alt="View Report" style="margin-right: 10px; "/>
							    </div>
							    <div class="end"></div>
							</div>
<!--
