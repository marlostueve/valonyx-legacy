...
<%@ include file="channels\channel-admin-menu.jsp" %>
					...
					<div class="main">
						...
						<p class="headlineA">Practice Profile</p>
						...
						<struts-html:form action="/admin/organizationMain" focus="nameInput">
							...
							<p>
								<input class="formbutton" type="submit" name="submit_button" value="Update Practice" alt="Update Practice" style="margin-right: 10px; "/>
								<input class="formbutton" type="submit" name="submit_button" value="Delete Practice" alt="Delete Practice" onclick="javascript:return confirm('Are you sure?');" />
