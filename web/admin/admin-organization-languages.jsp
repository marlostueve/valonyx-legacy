...
<%@ include file="channels\channel-organization-menu.jsp" %>
			...
			<TABLE WIDTH=522 BORDER=0 CELLPADDING=1 CELLSPACING=0 BGCOLOR="#BBBBBB">
				<TR HEIGHT=26>
					<TD ALIGN=left BACKGROUND="../images/PttrsnUK_TableHeaderBG2.jpg"><P style="font-size: 13pt; font-family: Arial; font-weight: bold; color: #000000;">&nbsp;Language</P></TD>
				</TR>
				<TR>
					<TD>
						<TABLE WIDTH=520 BORDER=0 CELLPADDING=1 CELLSPACING=0 BGCOLOR="#FFFFFF">
                                                    <struts-html:form action="/admin/organizationLanguages">
							...
							<TR HEIGHT=30>
								<TD valign="top"><P style="font-size: 9pt; font-family: Arial; font-weight: bold; color: #000000;">&nbsp;Available Languages:</P></TD>
								<TD>
								    <select name="language" style="font-size: 9pt; font-family: Arial; width: 300px;" size="7">
<%
Iterator itr = LanguageBean.getLanguages().iterator();
while (itr.hasNext())
{
    LanguageBean language = (LanguageBean)itr.next();
%>
									<option value="<%= language.getValue() %>"><%= language.getLabel() %>
<%
}
%>
								    </select>
							...
							<TR HEIGHT=30>
								<TD ALIGN=right COLSPAN=2><INPUT TYPE="submit" NAME="assign" VALUE="Assign Language"><IMG SRC="../images/trspacer.gif" WIDTH=12 HEIGHT=1 ALT=""></TD>
							</TR>
							<TR HEIGHT=2>
								<TD ALIGN=left COLSPAN=2><IMG SRC="../images/trspacer.gif" WIDTH=1 HEIGHT=1 ALT=""></TD>
							</TR>
			...
			<TABLE WIDTH=522 BORDER=0 CELLPADDING=1 CELLSPACING=0 BGCOLOR="#6F9BCB">
				<TR HEIGHT=26>
					<TD ALIGN=left BACKGROUND="../images/PttrsnUK_TableHeaderBG3.jpg"><P style="font-size: 13pt; font-family: Arial; font-weight: bold; color: #000000;">&nbsp;Assigned Languages</P></TD>
				</TR>
				<TR>
					<TD>
						<TABLE WIDTH=520 BORDER=0 CELLPADDING=1 CELLSPACING=0 BGCOLOR="#FFFFFF">
...
try
{
    Iterator languages = adminCompany.getSupportedLanguages().iterator();
    if (languages.hasNext())
    {
        while (languages.hasNext())
        {
            LanguageBean obj = (LanguageBean)languages.next();
%>
...
%>
								...
								<TD ALIGN=left COLSPAN=6><IMG SRC="../images/trspacer.gif" WIDTH=1 HEIGHT=1 ALT=""></TD>
                                                        ...
                                                        <TR>
								<TD ALIGN=left COLSPAN=8><p style="font-size: 9pt; font-family: Arial; color: #ff0000;">No Languages Found</p></TD>
							</TR>
                                                        <TR BGCOLOR="#DDDDDD">
								<TD ALIGN=left COLSPAN=6><IMG SRC="../images/trspacer.gif" WIDTH=1 HEIGHT=1 ALT=""></TD>
							</TR>
