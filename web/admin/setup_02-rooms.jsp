...
String prac_message = "Setup the Rooms for " + adminCompany.getLabel() + ".";
...
%>
	...
	<div class="content_Administration">
		...
		<struts-html:form action="/admin/setup02Room" focus="roomNameInput">
...
%>
		    <div class="adminItem"><strong style="font-weight: bolder;">Provide the Name</strong> of the room.</div>

		    <div class="adminItem">
			<div class="leftTM">ROOM NAME</div>
			<div class="right">
			    <input name="roomNameInput" onfocus="select();" value="<%= adminPractitioner.getLastNameString() %>" size="31" maxlength="30" class="inputbox" style="width: 206px;" />
			</div>
			<div class="end"></div>
		    </div>
<%
...
%>
		    ...
		    <div class="adminItem">If you'd like to allow your clients to request appointments online for this room, <strong style="font-weight: bolder;">click the Allow Client Scheduling button</strong>.</div>  
			...
			<div id="submitbuttonsfrommarkup2" class="right">
			    <input id="submitbutton4" class="formbutton" type="submit" name="submit_button" value="<%= adminPractitioner.isNew() ? "Add" : "Update" %> Room" alt="<%= adminPractitioner.isNew() ? "Add" : "Update" %> Room" style="margin-right: 10px; "/>
			</div>
			<div class="end"></div>
		    </div>
<%
...
%>
		    <div class="adminItem">Choose a Room name from the list below to edit that Room.</div>
<%
}
%>
			    ...
			    <div class="heading">
				    <table cellspacing="0" cellpadding="0" border="0" summary="">
					    ...
					    <tr style="display: block;">
						    ...
						    <td style="width: 472px; text-align: left;  ">Rooms</td>
					    </tr>
				    </table>
			    </div>
			    <div class="horizontalRule"><img src="images/trspacer.gif" width="1" height="1" alt="" /></div>
...
%>
			    ...
			    <div class="organization">
				    <table cellspacing="0" cellpadding="0" border="0" summary="">
					    <tr>
						    <td style="width:  20px; text-align: left;  "></td>
						    <td style="width: 402px; text-align: left;  "><a href="setup_02-rooms.jsp?id=<%= practitioner.getValue() %>" title=""><%= practitioner.getLabel() %></a></td>
...
%>
			    <div class="organization">
				    <table cellspacing="0" cellpadding="0" border="0" summary="">
					    <tr>
						    <td style="width:  20px; text-align: left;  "></td>
						    <td style="width: 472px; text-align: left;  ">No Rooms Found</td>
					    </tr>
				    </table>
			    </div>
<%
