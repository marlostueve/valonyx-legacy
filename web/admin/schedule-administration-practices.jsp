...
<div id="center1" style="background-color: white; height: 100%;">
	...
	<div class="content_TextBlock">
		<p class="headline"><%= adminCompany.getLabel() %> Administration - Practice Manager</p>
...
<%@ include file="channels\channel-setup-menu.jsp" %>
					...
					<div class="main">
						...
						<p>Use this screen to select a Practice to manage.</p>
							...
							<div class="heading">
								<table cellspacing="0" cellpadding="0" border="0" summary="">
									...
									<tr style="display: block;">
										...
										<td style="width: 472px; text-align: left;  ">Practice</td>
									</tr>
								</table>
							</div>
							<div class="horizontalRule"><img src="images/trspacer.gif" width="1" height="1" alt="" /></div>
<%
List companies = UKOnlineCompanyBean.getCompanies(loginBean.getPerson());
if (companies.size() > 0)
{
...
%>
							...
							<div class="organization">
								<table cellspacing="0" cellpadding="0" border="0" summary="">
									<tr>
										<td style="width:  20px; text-align: left;  "></td>
										<td style="width: 472px; text-align: left;  "><a href="setup_01.jsp?id=<%= companyObj.getValue() %>" title=""><%= companyObj.getLabel() %></a></td>
									</tr>
								</table>
							</div>
...
%>
							<div class="organization">
								<table cellspacing="0" cellpadding="0" border="0" summary="">
									<tr>
										<td style="width:  20px; text-align: left;  "></td>
										<td style="width: 472px; text-align: left;  ">No Practices Found</td>
									</tr>
								</table>
							</div>
<%
