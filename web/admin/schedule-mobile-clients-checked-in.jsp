	...
	<div id="wrap">
		...
		<div id="sidebar">
			...
			<div class="content">
				...
				<ul class="nav">
					<li><a href="schedule-mobile.jsp"><span class="ico msg"></span>Schedule</a></li>
					<li><a href="schedule-mobile-clients-checked-in.jsp" class="active"><span class="ico msg"></span>Checked In<span class="info">&nbsp;2&nbsp;</span></a></li>
					<li><a href="?"><span class="ico msg"></span>Checked Out<span class="info">&nbsp;6&nbsp;</span></a></li>
					<li><a href="?"><span class="ico msg"></span>Clients<span class="info">566</span></a></li>
