...
<%@ include file="channels\channel-navbar.jsp" %>
    ...
    <div class="container">
      ...
      <div class="hero-unit">
		...
		<p>Please enter your email address below.  This will allow us to better communicate with you.</p>
		
		<struts-html:form styleId="loginform" styleClass="form-signin" action="/client/enterEmail" focus="email">
			  <h2 class="form-signin-heading">Enter your email address</h2>
			  <input type="text" name="email" class="input-block-level" placeholder="Email Address">
			  <button class="btn btn-large btn-primary" type="submit">Done &raquo;</button>
			  <a style="margin-left: 10px;" class="btn btn-large" href="index.jsp">Skip</a>
		</struts-html:form>
<%

	String errorMessage = (String)session.getAttribute("forgot-password-message");
	if (errorMessage != null) {
		boolean isError = errorMessage.indexOf("Error") > -1 || errorMessage.indexOf("Failed") > -1 || errorMessage.indexOf("not found") > -1;
%>
			<div class="alert <%= isError ? "alert-error" : "alert-success" %>">
				<button type="button" class="close" data-dismiss="alert">×</button>
				<h3><%= isError ? "Oh Snap!!" : "Success!!" %></h3>
				<%= errorMessage %>
