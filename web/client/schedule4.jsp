      ...
      <div class="hero-unit">
		...
		<struts-html:form styleId="loginform" styleClass="form-signin" action="/client/scheduleConfirm">
			...
			<input type="hidden" name="start" value="<%= start_str %>" />
			  ...
			  <h4>Your request has been submitted.  You will receive email or phone confirmation when your request is confirmed.  Thank you!</h4>
			

			  <p>&nbsp</p>
			  <a style="margin-left: 10px;" class="btn btn-large" href="index.jsp">Go home</a>
		</struts-html:form>
<%
