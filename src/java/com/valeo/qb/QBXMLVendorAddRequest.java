 ...
 * @author marlo
 */
public class QBXMLVendorAddRequest
		...
		throws TorqueException, ObjectNotFoundException
    {
		...
		if (qb_request == null)
		{
			...
			qb_request = QBXMLVendorAddRequest.getRequest((QbRequestDb)objList.get(0));
		}
		...
		throws TorqueException
    {
		...
		if (qb_request == null)
		{
			qb_request = new QBXMLVendorAddRequest(_request);
    ...
    public
    QBXMLVendorAddRequest(QbRequestDb _request)
    {
		qb_request = _request;
		isNew = false;
    }
	...
	protected void assembleRequestBody() throws WritingException {
      ...
      <IncludeRetElement>STRTYPE</IncludeRetElement>        <!-- opt, may rep, max length = 50 for QBD|QBCA|QBUK|QBAU, not in QBOE, v4.0 -->
		...
		xmlwriter.writeEntity("VendorAddRq");
		xmlwriter.writeAttribute("requestID", getRequestId());

		xmlwriter.writeEntity("VendorAdd");
	...
	public String getLabel() {
		return CUBean.getUserTimeString(super.creation_date) + " - Vendor Add Request";
	}
