	...
	extends QBXMLRequest
{
		...
		throws TorqueException, ObjectNotFoundException
    {
		...
		if (qb_request == null)
		{
			...
			qb_request = QBXMLJournalEntryQueryRequest.getRequest((QbRequestDb)objList.get(0));
		}
		...
		throws TorqueException
    {
		...
		if (qb_request == null)
		{
			qb_request = new QBXMLJournalEntryQueryRequest(_request);
    ...
    public
    QBXMLJournalEntryQueryRequest(QbRequestDb _request)
    {
		qb_request = _request;
		isNew = false;
    }
	...
	{
		xmlwriter.writeEntity("JournalEntryQueryRq");
	...
	getLabel()
	{
		return CUBean.getUserTimeString(super.creation_date) + " - Journal Entry Request";
	}
