/*
 * CourseEnrollRequestResponseAction.java
 *
 * Created on June 22, 2006, 11:04 AM
 *
 */
 ...
 */
public final class
CourseEnrollRequestResponseAction
	extends Action
{
	...
	execute(ActionMapping _mapping, ActionForm _form, HttpServletRequest _request, HttpServletResponse _response)
		throws Exception
	{
		System.out.println("execute() invoked in CourseEnrollRequestResponseAction");
