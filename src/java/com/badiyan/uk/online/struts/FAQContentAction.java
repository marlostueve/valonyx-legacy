	...
	extends Action
{
	...
	execute(ActionMapping _mapping, ActionForm _form,
		...
		throws Exception
	{
		System.out.println("execute() invoked in FAQContentAction");
		...
		try
		{
			...
			String answerInput = (String)PropertyUtils.getSimpleProperty(_form, "answerInput");

			FAQElementBean faqElement = new FAQElementBean();
			faqElement.setQuestion(questionInput);
			faqElement.setAnswer(answerInput);
			faqElement.setFAQ(faqBean);
			faqElement.save();
			faqBean.addElement(faqElement);
