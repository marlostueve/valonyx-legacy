...
/**
 * Implementation of <strong>Action</strong> that validates a dfg.
 *
 * @author Marlo Stueve
 */
public final class
CertificationCoursesAction
	extends Action
{
	...
	execute(ActionMapping _mapping, ActionForm _form,
		...
		throws Exception
	{
		System.out.println("execute() invoked in CertificationCoursesAction");
		...
		try
		{
			...
			CourseBean assCourse = CourseBean.getCourse(Integer.parseInt(titleSelect));
			certBean.addCourse(assCourse);
