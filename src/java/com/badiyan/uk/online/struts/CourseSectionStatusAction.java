	...
	extends Action
{
	...
	execute(ActionMapping _mapping, ActionForm _form,
		...
		throws Exception
	{
		System.out.println("execute() invoked in CourseSectionStatusAction");

		ActionErrors errors = new ActionErrors();

		UKOnlineLoginBean loginBean = null;
		CompanyBean adminCompany = null;
		CourseSectionStatusBean status = null;
		...
		try
		{
			...
			if (session != null)
			{
				...
				status = (CourseSectionStatusBean)session.getAttribute("adminCourseSectionStatus");
			}
			else
