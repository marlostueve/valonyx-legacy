	...
	extends Action
{
	...
	execute(ActionMapping _mapping, ActionForm _form,
		...
		throws Exception
	{
		System.out.println("execute() invoked in NewMarketingPlanAction");
		...
		MarketingPlan adminMarketingPlan = null;
		...
		try
		{
			...
			if (session != null)
			{
				...
				adminMarketingPlan = (MarketingPlan)session.getAttribute("adminMarketingPlan");
			}
			else
