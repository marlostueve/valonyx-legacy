	...
	extends Action
{
	...
	execute(ActionMapping _mapping, ActionForm _form,
		...
		throws Exception
	{
		System.out.println("execute() invoked in OrganizationRolesAction");

		ActionErrors errors = new ActionErrors();

		UKOnlineLoginBean loginBean = null;
		CompanyBean adminCompany = null;
		RoleBean adminRole = null;
		...
		try
		{
			...
			if (session != null)
			{
				...
				adminRole = (RoleBean)session.getAttribute("adminRole");
			}
			else
			...
			adminRole.setName(nameInput);
			adminRole.setCompany(adminCompany);
			adminRole.save();
