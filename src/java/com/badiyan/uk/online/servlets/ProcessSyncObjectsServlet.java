/*
 * ProcessSyncObjectsServlet.java
 *
 * Created on March 8, 2007, 2:45 PM
 */
 ...
 */
public class
ProcessSyncObjectsServlet
    extends HttpServlet
{
    
    private Vector sync_objects = null;
    private UKOnlineLoginBean loginBean = null;
    private ProcessSyncObjectTask sync_task = null;
	...
	try
	{
		...
		sync_task = new ProcessSyncObjectTask(this, messages);
